...
$( document ).ready( function(){
  ...
  $.getJSON( "stateInfoList.json", function( data ){
    ...
    function GetModule( ParseJsonModule ){
        
        // PARSE JSON
        $.each ( data, function( key, val ){
            // console.log ( key, val.contacts );//key is "nh" or "fl", val is whats inside json's { }s
            function ParseJsonModule( jsonKeyF, contactsF, productTypesF ){
            ...
            }//closing for ParseJsonModule(jsonKey,contactsF,productTypesF){
            
            return {
                ParseJsonModule: ParseJsonModule  
            };
            
        })//CLOSING .EACH HERE    
        
    }//closing for function GetModule( ParseJsonModule ){  // when was IIFE (); ~wasn't IIFE supposed to close w ")();" and a "(" in front of function keyword above?
